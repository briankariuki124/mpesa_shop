...
<body>
    <div class="row">
        ...
        <div class="col-8 col-md-8 col-lg-8 col-sm-8" style="margin-top: 10vh;">
            <form action="reg_handler.php" method="post" class="lg">
                <div class="imgcontainer">
                    <img src="resources/camcat2.png" alt="Avatar" class="avatar">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control m" placeholder="Full Name" name="fn" required>
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-primary" value="submit" name="sign_up">Sign Up</button>
            </form>
        </div>
        <div class="col-2 col-md-2 col-lg-2 col-sm-2"></div>
    </div>
